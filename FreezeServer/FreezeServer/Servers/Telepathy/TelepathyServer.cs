...
namespace Telepathy
{
    public class TelepathyServer : Common, IServer
    {
        // listener
        ...
        public TelepathyServer(int port)
        {
            Port = port;
        }
                ...
                while (true)
                {
                    ...
                    Thread receiveThread = new Thread(() =>
                    {
                        ...
                        try
                        {
                            ...
                            ReceiveLoop(connectionId, client, eventQueue, packageQueue, MaxMessageSize);
        ...
        public bool Start(int port)
        {
            ...
            eventQueue = new ConcurrentQueue<StateMessage>();
